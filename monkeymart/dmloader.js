...
var EngineLoader = {
    ...
    loadWasmAsync: function(exeName) {
        if (EngineLoader.stream_wasm && (typeof WebAssembly.instantiateStreaming === "function")) {
            ...
            EngineLoader.loadAndInstantiateWasmAsync("https://cdn.jsdelivr.net/gh/brooklynruff/d@refs/heads/main/monkeymart/" + exeName + ".wasm", 0, 40, function() {
                EngineLoader.loadAndRunScriptAsync("https://cdn.jsdelivr.net/gh/brooklynruff/d@refs/heads/main/monkeymart/" + exeName + '_wasm.js', EngineLoader.wasmjs_size, 40, 50);
            });
        }
    },
