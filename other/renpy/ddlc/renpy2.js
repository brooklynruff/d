...
(
  function () {
    ...
    var loadPackage = function (metadata) {
      ...
      var PACKAGE_NAME = 'https://cdn.jsdelivr.net/gh/brooklynruff/d@main/other/renpy/ddlc/renpy.data';
      var REMOTE_PACKAGE_BASE = 'https://cdn.jsdelivr.net/gh/brooklynruff/d@main/other/renpy/ddlc/renpy.data';
      if (
      ...
      function runWithFS() {
        ...
        Module['FS_createPath'](
          '/lib/python3.11/urllib3/contrib',
          '_securetransport',
          true,
          true
        );
...
var ASM_CONSTS = {
  ...
  5327319: ($0, $1, $2, $3, $4) => {
    ...
    var url = hot_x === 0 &&
    hot_y === 0 ? 'url(' + canvas.toDataURL() + '), auto' : 'url(' + canvas.toDataURL() + ') ' + hot_x + ' ' + hot_y + ', auto';
...
function ___assert_fail(condition, filename, line, func) {
  abort(
    'Assertion failed: ' + UTF8ToString(condition) + ', at: ' + [filename ? UTF8ToString(filename) : 'unknown filename',
    line,
...
var IDBFS = {
  ...
  reconcile: (src, dst, callback) => {
    var total = 0;
    var create = [];
    Object.keys(src.entries).forEach(
      function (key) {
    ...
    var remove = [];
    Object.keys(dst.entries).forEach(
      function (key) {
        if (!src.entries[key]) {
          remove.push(key);
          total++
...
var SOCKFS = {
  ...
  websocket_sock_ops: {
    ...
    recvmsg: function (sock, length) {
      ...
      var queuedLength = queued.data.byteLength ||
      queued.data.length;
      var queuedOffset = queued.data.byteOffset ||
      0;
      var queuedBuffer = queued.data.buffer ||
      queued.data;
...
function getSocketAddress(addrp, addrlen, allowNull) {
  ...
  info.addr = DNS.lookup_addr(info.addr) ||
  info.addr;
  return info
}
...
function ___syscall_sendmsg(fd, message, flags) {
  try {
    ...
    if (name) {
      ...
      port = info.port;
      addr = DNS.lookup_addr(info.addr) ||
      info.addr
    }
    var total = 0;
    for (var i = 0; i < num; i++) {
...
var Browser = {
  mainLoop: {
    ...
    updateStatus: function () {
      if (Module['setStatus']) {
        var message = Module['statusMessage'] ||
        'Please wait...';
        var remaining = Browser.mainLoop.remainingBlockers;
...
var GL = {
  ...
  makeContextCurrent: function (contextHandle) {
    ...
    Module.ctx = GLctx = GL.currentContext &&
...
function __glGetActiveAttribOrUniform(funcName, program, index, bufSize, length, size, type, name) {
  ...
  if (info) {
    var numBytesWrittenExclNull = name &&
...
function _emscripten_glGetProgramInfoLog(program, maxLength, length, infoLog) {
  ...
  var numBytesWrittenExclNull = maxLength > 0 &&
  infoLog ? stringToUTF8(log, infoLog, maxLength) : 0;
  if (length) HEAP32[length >> 2] = numBytesWrittenExclNull
}
...
function _emscripten_glGetShaderSource(shader, bufSize, length, source) {
  ...
  if (!result) return;
  var numBytesWrittenExclNull = bufSize > 0 &&
  source ? stringToUTF8(result, source, bufSize) : 0;
  if (length) HEAP32[length >> 2] = numBytesWrittenExclNull
}
...
function __colorChannelsInGlTextureFormat(format) {
  ...
  return colorChannels[format - 6402] ||
  1
}
...
function fillFullscreenChangeEventData(eventStruct) {
  ...
  var id = reportedElement &&
  reportedElement.id ? reportedElement.id : '';
...
function fillPointerlockChangeEventData(eventStruct) {
  ...
  var id = pointerLockElement &&
  pointerLockElement.id ? pointerLockElement.id : '';
...
function _setprotoent(stayopen) {
  ...
  if (list.length === 0) {
    var entry = allocprotoent('tcp', 6, [
      'TCP'
    ]);
    list.push(entry);
    map['tcp'] = map['6'] = entry;
    entry = allocprotoent('udp', 17, [
      'UDP'
    ]);
    list.push(entry);
...
var ___wasm_call_ctors = Module['___wasm_call_ctors'] = function () {
  return (
    ___wasm_call_ctors = Module['___wasm_call_ctors'] = Module['asm']['yh']
...
var ___errno_location = Module['___errno_location'] = function () {
  return (
    ___errno_location = Module['___errno_location'] = Module['asm']['Eh']
  ).apply(null, arguments)
};
...
var _emscripten_builtin_memalign = Module['_emscripten_builtin_memalign'] = function () {
  return (
    _emscripten_builtin_memalign = Module['_emscripten_builtin_memalign'] = Module['asm']['Ih']
  ).apply(null, arguments)
};
...
var dynCall_iiiiiiii = Module['dynCall_iiiiiiii'] = function () {
  return (
    dynCall_iiiiiiii = Module['dynCall_iiiiiiii'] = Module['asm']['Wh']
  ).apply(null, arguments)
};
var dynCall_iiiiiiiiiii = Module['dynCall_iiiiiiiiiii'] = function () {
  return (
    dynCall_iiiiiiiiiii = Module['dynCall_iiiiiiiiiii'] = Module['asm']['Xh']
  ).apply(null, arguments)
};
var dynCall_iiiiiii = Module['dynCall_iiiiiii'] = function () {
  return (
    dynCall_iiiiiii = Module['dynCall_iiiiiii'] = Module['asm']['Yh']
  ).apply(null, arguments)
};
var dynCall_iiiiiiiiii = Module['dynCall_iiiiiiiiii'] = function () {
  return (
    dynCall_iiiiiiiiii = Module['dynCall_iiiiiiiiii'] = Module['asm']['Zh']
  ).apply(null, arguments)
};
...
var dynCall_viiiiii = Module['dynCall_viiiiii'] = function () {
  return (
    dynCall_viiiiii = Module['dynCall_viiiiii'] = Module['asm']['ei']
  ).apply(null, arguments)
};
var dynCall_viiiiiiiii = Module['dynCall_viiiiiiiii'] = function () {
  return (
    dynCall_viiiiiiiii = Module['dynCall_viiiiiiiii'] = Module['asm']['fi']
  ).apply(null, arguments)
};
...
var dynCall_viiiffff = Module['dynCall_viiiffff'] = function () {
  return (
    dynCall_viiiffff = Module['dynCall_viiiffff'] = Module['asm']['li']
  ).apply(null, arguments)
};
var dynCall_viiiiffff = Module['dynCall_viiiiffff'] = function () {
  return (
    dynCall_viiiiffff = Module['dynCall_viiiiffff'] = Module['asm']['mi']
  ).apply(null, arguments)
};
var dynCall_viiiiiffff = Module['dynCall_viiiiiffff'] = function () {
  return (
    dynCall_viiiiiffff = Module['dynCall_viiiiiffff'] = Module['asm']['ni']
  ).apply(null, arguments)
};
var dynCall_iiiiddi = Module['dynCall_iiiiddi'] = function () {
  return (
    dynCall_iiiiddi = Module['dynCall_iiiiddi'] = Module['asm']['oi']
  ).apply(null, arguments)
};
var dynCall_vidddddd = Module['dynCall_vidddddd'] = function () {
  return (
    dynCall_vidddddd = Module['dynCall_vidddddd'] = Module['asm']['pi']
  ).apply(null, arguments)
};
...
var dynCall_iiiiddddiiii = Module['dynCall_iiiiddddiiii'] = function () {
  return (
    dynCall_iiiiddddiiii = Module['dynCall_iiiiddddiiii'] = Module['asm']['ti']
  ).apply(null, arguments)
};
var dynCall_iiddiddiii = Module['dynCall_iiddiddiii'] = function () {
  return (
    dynCall_iiddiddiii = Module['dynCall_iiddiddiii'] = Module['asm']['ui']
  ).apply(null, arguments)
};
var dynCall_iiiddidddiii = Module['dynCall_iiiddidddiii'] = function () {
  return (
    dynCall_iiiddidddiii = Module['dynCall_iiiddidddiii'] = Module['asm']['vi']
  ).apply(null, arguments)
};
var dynCall_iiiiddidddiiii = Module['dynCall_iiiiddidddiiii'] = function () {
  return (
    dynCall_iiiiddidddiiii = Module['dynCall_iiiiddidddiiii'] = Module['asm']['wi']
  ).apply(null, arguments)
};
var dynCall_viiiiiii = Module['dynCall_viiiiiii'] = function () {
  return (
    dynCall_viiiiiii = Module['dynCall_viiiiiii'] = Module['asm']['xi']
  ).apply(null, arguments)
};
...
var dynCall_iiiiiiiiiiiiiifii = Module['dynCall_iiiiiiiiiiiiiifii'] = function () {
  return (
    dynCall_iiiiiiiiiiiiiifii = Module['dynCall_iiiiiiiiiiiiiifii'] = Module['asm']['Ei']
  ).apply(null, arguments)
};
...
var dynCall_viiiiiiiiiiii = Module['dynCall_viiiiiiiiiiii'] = function () {
  return (
    dynCall_viiiiiiiiiiii = Module['dynCall_viiiiiiiiiiii'] = Module['asm']['Gi']
  ).apply(null, arguments)
};
var dynCall_viiiiiiiiii = Module['dynCall_viiiiiiiiii'] = function () {
  return (
    dynCall_viiiiiiiiii = Module['dynCall_viiiiiiiiii'] = Module['asm']['Hi']
  ).apply(null, arguments)
};
var dynCall_viiiiiiii = Module['dynCall_viiiiiiii'] = function () {
  return (
    dynCall_viiiiiiii = Module['dynCall_viiiiiiii'] = Module['asm']['Ii']
  ).apply(null, arguments)
};
...
var dynCall_iiiiiiidiiddii = Module['dynCall_iiiiiiidiiddii'] = function () {
  return (
    dynCall_iiiiiiidiiddii = Module['dynCall_iiiiiiidiiddii'] = Module['asm']['Ki']
  ).apply(null, arguments)
};
...
var dynCall_iiiiiiiii = Module['dynCall_iiiiiiiii'] = function () {
  return (
    dynCall_iiiiiiiii = Module['dynCall_iiiiiiiii'] = Module['asm']['Qi']
  ).apply(null, arguments)
};
var dynCall_iiiiiiiiiiiii = Module['dynCall_iiiiiiiiiiiii'] = function () {
  return (
    dynCall_iiiiiiiiiiiii = Module['dynCall_iiiiiiiiiiiii'] = Module['asm']['Ri']
  ).apply(null, arguments)
};
var dynCall_iiiiiiiiiiii = Module['dynCall_iiiiiiiiiiii'] = function () {
  return (
    dynCall_iiiiiiiiiiii = Module['dynCall_iiiiiiiiiiii'] = Module['asm']['Si']
  ).apply(null, arguments)
};
var dynCall_viiiiiiiiiii = Module['dynCall_viiiiiiiiiii'] = function () {
  return (
    dynCall_viiiiiiiiiii = Module['dynCall_viiiiiiiiiii'] = Module['asm']['Ti']
  ).apply(null, arguments)
};
var dynCall_viiiffi = Module['dynCall_viiiffi'] = function () {
  return (
    dynCall_viiiffi = Module['dynCall_viiiffi'] = Module['asm']['Ui']
  ).apply(null, arguments)
};
var dynCall_viiiffffi = Module['dynCall_viiiffffi'] = function () {
  return (
    dynCall_viiiffffi = Module['dynCall_viiiffffi'] = Module['asm']['Vi']
  ).apply(null, arguments)
};
var dynCall_viiiffffffi = Module['dynCall_viiiffffffi'] = function () {
  return (
    dynCall_viiiffffffi = Module['dynCall_viiiffffffi'] = Module['asm']['Wi']
  ).apply(null, arguments)
};
var dynCall_viiffffffi = Module['dynCall_viiffffffi'] = function () {
  return (
    dynCall_viiffffffi = Module['dynCall_viiffffffi'] = Module['asm']['Xi']
  ).apply(null, arguments)
};
var dynCall_viiffffi = Module['dynCall_viiffffi'] = function () {
  return (
    dynCall_viiffffi = Module['dynCall_viiffffi'] = Module['asm']['Yi']
  ).apply(null, arguments)
};
var dynCall_iiiiiiifii = Module['dynCall_iiiiiiifii'] = function () {
  return (
    dynCall_iiiiiiifii = Module['dynCall_iiiiiiifii'] = Module['asm']['Zi']
  ).apply(null, arguments)
};
...
var dynCall_iidiiii = Module['dynCall_iidiiii'] = function () {
  return (
    dynCall_iidiiii = Module['dynCall_iidiiii'] = Module['asm']['kj']
  ).apply(null, arguments)
};
var _asyncify_start_unwind = Module['_asyncify_start_unwind'] = function () {
  return (
    _asyncify_start_unwind = Module['_asyncify_start_unwind'] = Module['asm']['lj']
  ).apply(null, arguments)
};
var _asyncify_stop_unwind = Module['_asyncify_stop_unwind'] = function () {
  return (
    _asyncify_stop_unwind = Module['_asyncify_stop_unwind'] = Module['asm']['mj']
  ).apply(null, arguments)
};
var _asyncify_start_rewind = Module['_asyncify_start_rewind'] = function () {
  return (
    _asyncify_start_rewind = Module['_asyncify_start_rewind'] = Module['asm']['nj']
  ).apply(null, arguments)
};
var _asyncify_stop_rewind = Module['_asyncify_stop_rewind'] = function () {
  return (
    _asyncify_stop_rewind = Module['_asyncify_stop_rewind'] = Module['asm']['oj']
  ).apply(null, arguments)
};
var _Py_EMSCRIPTEN_SIGNAL_HANDLING = Module['_Py_EMSCRIPTEN_SIGNAL_HANDLING'] = 5334560;
var ___start_em_js = Module['___start_em_js'] = 5319864;
var ___stop_em_js = Module['___stop_em_js'] = 5320370;
