...
const buildUrl = "https://cdn.jsdelivr.net/gh/brooklynruff/d@main/racesurvival/Build";
const loaderUrl = buildUrl + "/yandexBrotli.loader.js";
const config = {
    dataUrl: buildUrl + "/yandexBrotli.data.br",
    frameworkUrl: buildUrl + "/yandexBrotli.framework.js.br",
...
loadingCover.style.background = "url('https://cdn.jsdelivr.net/gh/brooklynruff/d@main/racesurvival/background.png') center / cover";
