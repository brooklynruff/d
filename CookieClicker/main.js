...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		Game.goldenCookie.spawn=function()
		{
			...
			if ((Game.elderWrath==1 && Math.random()<0.33) || (Game.elderWrath==2 && Math.random()<0.66) || (Game.elderWrath==3))
			{
				...
				me.style.background='url(https://cdn.jsdelivr.net/gh/brooklynruff/d@main/CookieClicker/img/wrathCookie.png)';
			}
			else
			{
				Game.goldenCookie.wrath=0;
				me.style.background='url(https://cdn.jsdelivr.net/gh/brooklynruff/d@main/CookieClicker/img/goldCookie.png)';
			}
		...
		Game.veilOn=function()
		{
			...
			l('backgroundLayer2').style.background='#000 url(https://cdn.jsdelivr.net/gh/brooklynruff/d@main/CookieClicker/img/darkNoise.png)';
			Game.veil=1;
		}
		...
		Game.NewDrawFunction=function(pic,xVariance,yVariance,w,shift,heightOffset)
		{
			...
			return function()
			{
				...
				for (var i=0;i<this.amount;i++)
				{
					...
					str+='<div class="object" style="background:url(https://cdn.jsdelivr.net/gh/brooklynruff/d@main/CookieClicker/img/'+usedPic+'.png);left:'+x+'px;top:'+y+'px;z-index:'+Math.floor(1000+y)+';"></div>';
		...
		Game.RebuildStore=function()//redraw the store from scratch
		{
			...
			for (var i in Game.Objects)
			{
				...
				,0,0,'left')+' onclick="Game.ObjectsById['+me.id+'].buy();" id="product'+me.id+'"><div class="icon" style="background-image:url(https://cdn.jsdelivr.net/gh/brooklynruff/d@main/CookieClicker/img/'+me.icon+'.png);"></div><div class="content"><div class="title">'+me.displayName+'</div><span class="price">'+Beautify(Math.round(me.price))+'</span>'+(me.amount>0?('<div class="title owned">'+me.amount+'</div>'):'')+'</div></div>';
			}
			...
			if (Math.abs((Game.elderWrath+1)-Game.elderWrathD)>0.1)
			{
				if (Game.elderWrathD<1)
				{
					...
					if (Game.bg!=Game.defaultBg || Game.bgFade!=Game.defaultBg)
					{
						...
						l('backgroundLayer1').style.background='url(https://cdn.jsdelivr.net/gh/brooklynruff/d@main/CookieClicker/img/'+Game.bg+'.jpg)';
						l('backgroundLayer2').style.background='url(https://cdn.jsdelivr.net/gh/brooklynruff/d@main/CookieClicker/img/'+Game.bgFade+'.jpg)';
	...
	Game.Draw=function()
	{
		...
		if (Game.prefs.milk)
		{
			...
			m2o=1-m1o;
			if (m1.style.backgroundImage!='url(https://cdn.jsdelivr.net/gh/brooklynruff/d@main/CookieClicker/img/'+m1i+'.png') m1.style.backgroundImage='url(https://cdn.jsdelivr.net/gh/brooklynruff/d@main/CookieClicker/img/'+m1i+'.png)';
			if (m2.style.backgroundImage!='url(https://cdn.jsdelivr.net/gh/brooklynruff/d@main/CookieClicker/img/'+m2i+'.png') m2.style.backgroundImage='url(https://cdn.jsdelivr.net/gh/brooklynruff/d@main/CookieClicker/img/'+m2i+'.png)';
		...
		if (Game.prefs.particles)
		{
			...
			{
				if (Game.cookiesPs>=1000) l('cookieShower').style.backgroundImage='url(https://cdn.jsdelivr.net/gh/brooklynruff/d@main/CookieClicker/img/cookieShower3.png)';
				else if (Game.cookiesPs>=500) l('cookieShower').style.backgroundImage='url(https://cdn.jsdelivr.net/gh/brooklynruff/d@main/CookieClicker/img/cookieShower2.png)';
				else if (Game.cookiesPs>=50) l('cookieShower').style.backgroundImage='url(https://cdn.jsdelivr.net/gh/brooklynruff/d@main/CookieClicker/img/cookieShower1.png)';
