      ...
      return a = i(x.a.mark(function n() {
          ...
          return x.a.wrap(function(n) {
              for (;;) switch (n.prev = n.next) {
                  case 0:
                      return m = document.getElementById("slideshow"), p = document.getElementById("slideshow-top"), g = document.getElementById("slideshow-nav"), w = document.getElementById("slideshow-images"), p.className = "active", n.prev = 5, n.next = 8, f("".concat(B, "//cdn.jsdelivr.net/gh/brooklynruff/d@main/subv7/screenshots/1-small.jpg").concat(I));
                  case 8:
                      e = n.sent, n.next = 16;
                      break;
                  case 11:
                      return n.prev = 11, n.t0 = n.catch(5), n.next = 15, f("".concat(B, "//cdn.jsdelivr.net/gh/brooklynruff/d@main/subv7/screenshots/1.jpg").concat(I));
                  case 15:
                      e = n.sent;
                  case 16:
                      ...
                      return n.next = 31, f("".concat(B, "//cdn.jsdelivr.net/gh/brooklynruff/d@main/subv7/screenshots/1.jpg").concat(I));
                  case 31:
                      for (r = n.sent, t.querySelector("img").src = r.src, a = function(n) {
                              var e = h(),
                                  t = new Image;
                              t.src = "".concat(B, "//cdn.jsdelivr.net/gh/brooklynruff/d@main/subv7/screenshots/").concat(n + 1, "-small.jpg").concat(I), e.appendChild(t), e.setAttribute("data-idx", n), 1 === n ? e.className = "".concat(L, " right") : n === S.a.numScreenshots - 1 ? e.className = "".concat(L, " left") : e.className = "".concat(L, " inactive"), w.appendChild(e)
          ...
          return x.a.wrap(function(n) {
              for (;;) switch (n.prev = n.next) {
                  case 0:
                      ...
                      return i = Date.now(), n.next = 7, f("".concat(B, "//cdn.jsdelivr.net/gh/brooklynruff/d@main/subv7/screenshots/").concat(o + 1, ".jpg").concat(I));
                  case 7:
